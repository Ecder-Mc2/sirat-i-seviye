...
const getVakitIcon = (vakit: Partial<Vakit> | null) => { 
    ...
    if (name.includes('güneşin doğuşu')) return <Sunrise size={24} className="text-yellow-500" />; 
    if (name.includes('güneşin batışı')) return <Sunset size={24} className="text-orange-500" />; 
    if (name.includes('leyl')) return <Moon size={24} className="text-blue-400" />; 
    if (name.includes('zeval')) return <Sun size={24} className="text-red-500" />; 
    if (name.includes('nefeslenmesi')) return <Wind size={24} className="text-teal-400" />; 
    if (name.includes('fecr')) return <Star size={24} className="text-purple-400" />; 
