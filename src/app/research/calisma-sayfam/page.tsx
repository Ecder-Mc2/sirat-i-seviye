...
import { ArrowLeft, BookOpen, Info } from 'lucide-react'; // Sadece kullanılanları import edelim

export default function CalismaSayfamPage() { 
    ...
    useEffect(() => {
        // Bu sayfanın dinamiği diğerlerinden farklı olabilir, 
        // Şimdilik build'in geçmesi için sadeleştirildi.
        setPageInfo({ title: 'Çalışma Sayfam', icon: <BookOpen className="mr-3 text-cyan-400" /> });
    }, []);
