...
import { ArrowLeft, Globe, ChevronDown, Book, Settings as SettingsIcon, UserPlus, MessageSquare, HelpCircle, Film, Sunrise, Moon } from 'lucide-react'; 
    ...
    <main className="flex min-h-screen flex-col items-center p-4 bg-gray-900 text-white font-sans">
      <div className="w-full max-w-2xl">
        ...
        <div className="space-y-4">
            ...
            {/* DÜZELTME: Hatalı kapanış etiketi </Settings-Card> yerine </SettingsCard> kullanıldı. */}
