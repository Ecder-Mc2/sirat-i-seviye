...
import { ArrowLeft, Sun, Sunrise, Sunset, Moon, Globe, ChevronDown, Bell, Palette, Languages, Book, Settings as SettingsIcon, UserPlus, MessageSquare, HelpCircle, Film } from 'lucide-react';
...
const CITIES = {
    'ankara': { lat: 39.93, lon: 32.85, name: "Ankara" },
    'istanbul': { lat: 41.01, lon: 28.97, name: "Istanbul" },
    'izmir': { lat: 38.42, lon: 27.14, name: "Izmir" },
};
...
export default function SettingsPage() {
    ...
    const ayTepe = useMemo(() => {
        ...
        try {
            ...
            let riseDate = new Date(); riseDate.setHours(riseH, riseM, 0, 0);
            let setDate = new Date(); setDate.setHours(setH, setM, 0, 0);
    ...
    const handleSettingChange = async (settingKey: string, value: string) => {
        ...
        let updates: { [key: string]: any } = { [settingKey]: value };
    ...
    <main className="flex min-h-screen flex-col items-center p-4 bg-gray-900 text-white font-sans">
      <div className="w-full max-w-2xl">
        ...
        <div className="space-y-4">
            ...
            <SettingsCard title="Kayıt Olun" icon={<UserPlus />} cardKey="register" openCard={openCard} setOpenCard={setOpenCard}><PlaceholderCardContent text="Ayarlarınızı birden fazla cihazda senkronize edin." link="/settings/register" /></SettingsCard>
